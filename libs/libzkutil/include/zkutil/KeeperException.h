...
private:
	...
	KeeperException(const std::string & msg, const int32_t code, int) : DB::Exception(msg, DB::ErrorCodes::KEEPER_EXCEPTION), code(code)
	{
...
public:
	...
	KeeperException(const std::string & msg, const int32_t code) : KeeperException(msg + " (" + zerror(code) + ")", code, 0)
	{
	}
	...
	{
		return "zkutil::KeeperException";
	}
	const char * className() const throw()
	{
		return "zkutil::KeeperException";
	}
	KeeperException * clone() const
	{
		return new KeeperException(*this);
	}

...
public:
	static StoragePtr create(const std::string & name_, /// Имя таблицы.
	...
	std::string getRemoteDatabaseName() const
	{
		return remote_database;
	}
	std::string getRemoteTableName() const
	{
		return remote_table;
	}
...
private:
	StorageDistributed(const std::string & name_,

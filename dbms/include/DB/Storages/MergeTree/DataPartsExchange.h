  ...
  */
	...
	public:
		Service(MergeTreeData & data_, StoragePtr & storage_)
			: data(data_), owned_storage(storage_), log(&Logger::get(data.getLogName() + " (Replicated PartsService)"))
		{
		}
  ...
  */
	...
	public:
		...
		MergeTreeData::MutableDataPartPtr fetchPart(
			const String & part_name, const String & replica_path, const String & host, int port, bool to_detached = false);
	...
	private:
		MergeTreeData::MutableDataPartPtr fetchPartImpl(const String & part_name,

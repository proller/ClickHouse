...
#define DECLARE(TYPE, NAME, DEFAULT) TYPE NAME{ DEFAULT };
...
#undef DECLARE
	...
	{
#define TRY_SET(TYPE, NAME, DEFAULT) else if (name == #NAME) NAME.set(value);
...
#undef TRY_SET
	...
	{
#define TRY_SET(TYPE, NAME, DEFAULT) else if (name == #NAME) NAME.set(buf);
...
#undef TRY_SET
	...
	{
#define TRY_IGNORE(TYPE, NAME, DEFAULT) else if (name == #NAME) decltype(NAME)(DEFAULT).set(buf);

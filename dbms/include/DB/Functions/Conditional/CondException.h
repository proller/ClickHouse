...
namespace Conditional
{
	...
	public:
		...
		{
			return "DB::Conditional::Exception";
		}
		const char * className() const throw() override
		{
			return "DB::Conditional::Exception";
		}
		CondException * clone() const override
		{
			return new CondException{ *this };
		}
		void rethrow() const override
		{
			throw * this;
		}
		CondErrorCodes getCode() const
		{
			return code;
		}
		std::string getMsg1() const
		{
			return msg1;
		}
		std::string getMsg2() const
		{
			return msg2;
		}

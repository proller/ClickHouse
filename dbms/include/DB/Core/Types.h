...
template <typename T>
struct RemoveNullable<Nullable<T>>
{
	using Type = T;
};
...
template <typename T>
struct IsNumber<Nullable<T>>
{
	static constexpr bool value = IsNumber<T>::value;
};

template <>
struct IsNumber<UInt8>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<UInt16>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<UInt32>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<UInt64>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<Int8>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<Int16>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<Int32>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<Int64>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<Float32>
{
	static constexpr bool value = true;
};
template <>
struct IsNumber<Float64>
{
	static constexpr bool value = true;
};
...
struct TypeName;
template <typename T>
struct TypeName<Nullable<T>>
{
	static std::string get()
	{
		return "Nullable(" + TypeName<T>::get() + ")";
	}
};
...
template <>
struct TypeName<Nullable<void>> : TypeName<Null>
{
};

...
{
public:
	FlatDictionary(const std::string & name,
	...
	{
		return std::make_unique<FlatDictionary>(*this);
	}
...
private:
	...
	struct Attribute final
	{
		...
		std::tuple<UInt8, UInt16, UInt32, UInt64, Int8, Int16, Int32, Int64, Float32, Float64, StringRef> null_values;

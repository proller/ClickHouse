...
CREATE TABLE test.part_header_r1(x UInt32, y UInt32)
    ENGINE ReplicatedMergeTree('/clickhouse_temp/tables/test/part_header', '1') ORDER BY x
...
CREATE TABLE test.part_header_r2(x UInt32, y UInt32)
    ENGINE ReplicatedMergeTree('/clickhouse_temp/tables/test/part_header', '2') ORDER BY x
